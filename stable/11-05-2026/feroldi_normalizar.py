...
def normalizar(raw: dict) -> dict:
    ...
    # ── Performance ─────────────────────────────────────────────────────────
    # X0.83: incluye return_1y/3y/5y de yfinance hist además de TradingView
    performance = {
        k: _f(perf.get(k))
    ...
    out = {
        ...
        "edgar": {
            ...
            # X0.83 — campos balance sheet para computed ratios
        ...
        "ratios": {
            ...
            # X0.83: EPS proyectado desde yfinance forwardEps
            "eps_proj":      _f(ratios.get("eps_proj")),
        ...
        "market": {
            ...
            "next_earnings_date": market.get("next_earnings_date"),  # X0.83
        },
        "earnings": {
        ...
        # X0.83 — sección computed: ratios calculados desde EDGAR (pasan directo)
