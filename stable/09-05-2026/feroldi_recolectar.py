#!/usr/bin/env python3
"""
FEROLDI RECOLECTAR — v X0.77
Sistema Feroldi · @patonet
  Sistema: X0.77 (release actual)
  Archivo: X0.77 (última modificación en este release)
        ...
        if edgar.get("revenue") is None and fills.get("revenue") and (yf_currency != "USD" or _yf_currency_suspect):
            ...
            if yf_fx:
                ...
                _YF_MONETARY = ["revenue","net_income","operating_income","cfo",
                                "capex","sbc","dividendos","deuda_total","cash_real",
                                "shares","market_cap","total_assets","goodwill","fcf"]
